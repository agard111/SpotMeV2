...
public class private_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton msg = findViewById(R.id.privMsg);
        msg.setOnClickListener(v -> {
            if(!friends) {
                Toast.makeText(private_profile.this, "You must be friends to direct message" , Toast.LENGTH_SHORT).show();
        ...
        ImageButton match = findViewById(R.id.imageButton10);
        feed.setOnClickListener(v -> {
